<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="毕业院校" prop="biyeyuanxiao">
          <el-input v-model="ruleForm.biyeyuanxiao" 
              placeholder="毕业院校" clearable  :readonly="ro.biyeyuanxiao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="毕业院校" prop="biyeyuanxiao">
              <el-input v-model="ruleForm.biyeyuanxiao" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="学历" prop="xueli">
          <el-input v-model="ruleForm.xueli" 
              placeholder="学历" clearable  :readonly="ro.xueli"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.toudishijian" label="投递时间" prop="toudishijian">
              <el-input v-model="ruleForm.toudishijian" 
                placeholder="投递时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="公司账号" prop="gongsizhanghao">
          <el-input v-model="ruleForm.gongsizhanghao" 
              placeholder="公司账号" clearable  :readonly="ro.gongsizhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="公司账号" prop="gongsizhanghao">
              <el-input v-model="ruleForm.gongsizhanghao" 
                placeholder="公司账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="岗位待遇" prop="gangweidaiyu">
          <el-input v-model="ruleForm.gangweidaiyu" 
              placeholder="岗位待遇" clearable  :readonly="ro.gangweidaiyu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="岗位待遇" prop="gangweidaiyu">
              <el-input v-model="ruleForm.gangweidaiyu" 
                placeholder="岗位待遇" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="文件名称" prop="wenjianmingcheng">
          <el-input v-model="ruleForm.wenjianmingcheng" 
              placeholder="文件名称" clearable  :readonly="ro.wenjianmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="文件名称" prop="wenjianmingcheng">
              <el-input v-model="ruleForm.wenjianmingcheng" 
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.jianli" label="简历" prop="jianli">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.jianli)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="简要介绍" prop="jianyaojieshao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.jianyaojieshao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jianyaojieshao" label="简要介绍" prop="jianyaojieshao">
                    <span v-html="ruleForm.jianyaojieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gongsimingcheng = true;
          ...
          if(o=='gangweidaiyu'){
            this.ruleForm.gangweidaiyu = obj[o];
	    this.ro.gangweidaiyu = true;
            continue;
          }
          if(o=='gangweiyaoqiu'){
	    ...
	    this.ro.jianli = true;
          ...
          if(o=='jianyaojieshao'){
            this.ruleForm.jianyaojieshao = obj[o];
	    this.ro.jianyaojieshao = true;
            continue;
          }
        }
      }
      ...
      this.$http({
		...
		if(json.biyeyuanxiao!=''&&json.biyeyuanxiao){
                this.ruleForm.biyeyuanxiao = json.biyeyuanxiao
	    		this.ro.biyeyuanxiao = true;
		}
		if(json.xueli!=''&&json.xueli){
	...
	this.ruleForm.jianyaojieshao = this.ruleForm.jianyaojieshao.replace(reg,'../../../django7681v/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `toudijilu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.toudijiluCrossAddOrUpdateFlag = false;
						 this.parent.search();
