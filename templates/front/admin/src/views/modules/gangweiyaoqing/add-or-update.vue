      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="公司地址" prop="gongsidizhi">
          <el-input v-model="ruleForm.gongsidizhi" 
              placeholder="公司地址" clearable  :readonly="ro.gongsidizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="公司地址" prop="gongsidizhi">
              <el-input v-model="ruleForm.gongsidizhi" 
                placeholder="公司地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="注册编号" prop="zhucebianhao">
          <el-input v-model="ruleForm.zhucebianhao" 
              placeholder="注册编号" clearable  :readonly="ro.zhucebianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="注册编号" prop="zhucebianhao">
              <el-input v-model="ruleForm.zhucebianhao" 
                placeholder="注册编号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="邀请岗位" prop="yaoqinggangwei">
          <el-input v-model="ruleForm.yaoqinggangwei" 
              placeholder="邀请岗位" clearable  :readonly="ro.yaoqinggangwei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="邀请岗位" prop="yaoqinggangwei">
              <el-input v-model="ruleForm.yaoqinggangwei" 
                placeholder="邀请岗位" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gongsidizhi = true;
          ...
          if(o=='zhucebianhao'){
            this.ruleForm.zhucebianhao = obj[o];
	    this.ro.zhucebianhao = true;
            continue;
          }
          if(o=='yaoqinggangwei'){
            this.ruleForm.yaoqinggangwei = obj[o];
	    this.ro.yaoqinggangwei = true;
            continue;
          }
          if(o=='gangweidaiyu'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.gongsizhanghao!=''&&json.gongsizhanghao){
                this.ruleForm.gongsizhanghao = json.gongsizhanghao
	    		this.ro.gongsizhanghao = true;
		}
		if(json.gongsimingcheng!=''&&json.gongsimingcheng){
                this.ruleForm.gongsimingcheng = json.gongsimingcheng
	    		this.ro.gongsimingcheng = true;
		}
		if(json.gongsidizhi!=''&&json.gongsidizhi){
                this.ruleForm.gongsidizhi = json.gongsidizhi
	    		this.ro.gongsidizhi = true;
		}
		if(json.zhucebianhao!=''&&json.zhucebianhao){
                this.ruleForm.zhucebianhao = json.zhucebianhao
	    		this.ro.zhucebianhao = true;
		}
        } else {
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `gangweiyaoqing/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.gangweiyaoqingCrossAddOrUpdateFlag = false;
						 this.parent.search();
