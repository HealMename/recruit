    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="投诉内容" prop="tousuneirong">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.tousuneirong" label="投诉内容" prop="tousuneirong">
                    <span v-html="ruleForm.tousuneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.tousuneirong = this.ruleForm.tousuneirong.replace(reg,'../../../django7681v/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
