      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="岗位类型" prop="gangweileixing">
          <el-input v-model="ruleForm.gangweileixing" 
              placeholder="岗位类型" clearable  :readonly="ro.gangweileixing"></el-input>
        </el-form-item>
        <div v-else>
