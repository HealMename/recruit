<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="注册时间" prop="zhuceshijian">
          <el-input v-model="ruleForm.zhuceshijian" 
              placeholder="注册时间" clearable  :readonly="ro.zhuceshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="注册时间" prop="zhuceshijian">
              <el-input v-model="ruleForm.zhuceshijian" 
                placeholder="注册时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
